...
export const createHeader = () => {
  ...
  const logo = `<a href="/">
    <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" x="0px" y="0px" viewBox="0 0 35 43">
      ...
      <g stroke-linecap="round" stroke-linejoin="round" stroke-width=".36133329" paint-order="stroke fill markers">
          ...
          <g transform="matrix(1.2273 0 0 1.56017 -3.943 -6.25)">
            <ellipse cx="17.309" cy="8.5380001" fill="#585858" fill-rule="evenodd" clip-rule="evenodd" rx="3.45" ry="1.52"/>
